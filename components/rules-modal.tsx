                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                    <Tabs defaultValue="basics" className="w-full">
                        ...
                        <TabsContent value="basics" className="mt-6 space-y-6">
                            <Card className="p-6 bg-gradient-to-br from-blue-700/60 to-blue-600/60 border-blue-500/50 shadow-lg">
                            ...
                            <Card className="p-6 bg-gradient-to-br from-emerald-700/60 to-emerald-600/60 border-emerald-500/50 shadow-lg">
                                <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                            ...
                            <Card className="p-6 bg-gradient-to-br from-amber-700/60 to-amber-600/60 border-amber-500/50 shadow-lg">
                                <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        ...
                        <TabsContent value="cards" className="mt-6 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <Card className="p-6 bg-gradient-to-br from-red-700/60 to-red-600/60 border-red-500/50 shadow-lg">
                                ...
                                <Card className="p-6 bg-gradient-to-br from-yellow-700/60 to-yellow-600/60 border-yellow-500/50 shadow-lg">
                                    <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                                ...
                                <Card className="p-6 bg-gradient-to-br from-purple-700/60 to-purple-600/60 border-purple-500/50 shadow-lg">
                                    <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                                ...
                                <Card className="p-6 bg-gradient-to-br from-green-700/60 to-green-600/60 border-green-500/50 shadow-lg">
                                    <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                        ...
                        <TabsContent value="rules" className="mt-6 space-y-6">
                            <Card className="p-6 bg-gradient-to-br from-red-700/60 to-red-600/60 border-red-500/50 shadow-lg">
                                ...
                                <div className="space-y-3 text-white">
                                    <div className="flex items-start gap-3">
                                        <CheckCircle className="w-5 h-5 text-red-300 mt-0.5 flex-shrink-0" />
